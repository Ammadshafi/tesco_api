...
const { create_topics, get_all_topics, delete_topics, update_topic,get_one_topic } = require('../controller/Topic_controller')
const Topics_Router=express.Router()


Topics_Router.post('/create-topic',create_topics)
Topics_Router.get('/topic',get_all_topics)
Topics_Router.get('/topic/:id',get_one_topic)
